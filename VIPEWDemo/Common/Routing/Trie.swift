...
typealias PresenterBuilder = () -> Presenter

class Trie {
    typealias Node = TrieNode<String>
    private let root: Node
    private var presenters: [String: PresenterBuilder] = [:]
...
extension Trie {
    ...
    func insert(_ presenter: @escaping PresenterBuilder, at: String) throws {
    ...
    // swiftlint:disable identifier_name
    func getPresenter(at: String) throws -> PresenterBuilder? {
        guard contains(at) else {
